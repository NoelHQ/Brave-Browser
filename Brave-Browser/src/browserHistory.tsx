...
export interface BraveHistorySearch {
...
const userDataDirectoryPath = () => {
  ...
  return path.join(process.env.HOME, "Library", "Application Support", "Google", "Brave");
};
...
export function useBraveHistorySearch(query: string | undefined): BraveHistorySearch {
